...
import { Activity, IBotConnection, User, DirectLineOptions } from 'botframework-directlinejs';
...
export declare const doCardAction: (botConnection: IBotConnection, from: User, locale: string, sendMessage: (value: string, user: User, locale: string) => void) => (type: string, value: string) => void;
