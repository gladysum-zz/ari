...
var renderMarkdown = function (text, markdownOptions, onImageLoad) {
    ...
    var options = tslib_1.__assign({ gfm: true, tables: true, breaks: false, pedantic: false, sanitize: false, smartLists: true, silent: false, smartypants: false }, markdownOptions);
...
var ReactRenderer = (function () {
    ...
    ReactRenderer.prototype.code = function (code, language) {
        return this.addElement(React.createElement("code", { key: this.key++ }, He.unescape(code)));
    };
